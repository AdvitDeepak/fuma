...
Data loader configured for TOFU and RWKU datasets.
...
class TextForgetDatasetQA(Dataset):
    def __init__(self, dataset, data_path, tokenizer, model_family,  max_length=512, split = "forget10", loss_type="idk", target_idx=[0]):
        ...
        if dataset == "tofu":
            ...
            split = "forget_level2"
            self.forget_data = datasets.load_dataset(data_path, split)["test"]
            self.retain_data =datasets.load_dataset(data_path, split)["test"]
