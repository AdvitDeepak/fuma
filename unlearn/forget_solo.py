...
Main Code for unlearning a set of examples from the specified dataset.
...
def main(cfg):
    ...
    set_seed(cfg.seed)
    cfg.LoRA.r = cfg.rank
    cfg.save_dir = f"{cfg.model_save}/{cfg.dataset}_{cfg.forget_loss}_{cfg.lr}_{cfg.LoRA.r}_{cfg.num_epochs}_{'-'.join(map(str, cfg.target_idx))}"
    ...
    # Added to saving args
    save_every_n_epochs = max_steps // 10 # usually this should be 1
